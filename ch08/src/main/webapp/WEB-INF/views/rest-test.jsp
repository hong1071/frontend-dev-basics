	...
	<script>
		$(function(){
			...
			$("#update").click(function(){
				...
				$.ajax({
					url: "${pageContext.request.contextPath }/api/user/10",
					type: 'put',						// 요청 method, server.xml의 Connector에 parseBodyMethods="POST, PUT, DELETE"를 추가 해주어야 한다.
					dataType: 'json',					// 받을 포맷
					contentType: 'application/json',
					data: JSON.stringify(vo),
					success: function(response){
			...
			$("#delete").click(function(){
				...
				$.ajax({
					url: "${pageContext.request.contextPath }/api/user/10",
					type: 'delete',						// 요청 method, server.xml의 Connector에 parseBodyMethods="POST, PUT, DELETE"를 추가 해주어야 한다.
					dataType: 'json',					// 받을 포맷
